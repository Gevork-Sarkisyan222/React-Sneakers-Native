          ...
          {isLoading ? (
            ...
            <View className="flex justify-center items-center">
              ...
              >
                ...
                <Text className="text-white mr-[15px] text-[17px]">
                  Вернуться назад
                </Text>
              </Pressable>
            </View>
              ...
              <DrawerBody>
                {cartProducts.map((product) => (
                  <CartCard
                    ...
                    handleRemove={() =>
                      handleRemoveFromCart(product.id.toString(), product.title)
                    }
                  />
                ))}
              </DrawerBody>
            ...
            <View className="flex justify-center items-center">
              ...
              />
              <Text className="text-[22px] font-[600] mt-[20px] mb-[9px]">
                Корзина пустая
              </Text>
              <Text className="font-[400] text-[16px] text-[#9b9b9b] text-center">
          ...
          {!isOrdered && cartProducts.length > 0 && (
            <View className="flex flex-col">
              ...
              <View className="flex flex-row justify-between w-full">
                ...
                <View className="w-full border-b border-b-[#DFDFDF] flex-1 border-dashed mx-[9px]"></View>
                <Text className="font-bold">
                  {taxCount.toLocaleString("ru-RU")} руб.
                </Text>
              </View>
              ...
              >
                {isButtonLoading ? (
                  ...
                  <>
                    <Text className="text-white mr-[15px] text-[16px]">
                      Оформить заказ
                    </Text>
                    <Entypo
